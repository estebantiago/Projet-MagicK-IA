...
*/
//passo 1 - pegar o botao de aplicar filtros do HTML e mandar pro JS
const botaoFiltrar = document.querySelector('.btn-filtros');
...
const cartas = document.querySelectorAll('.carta');
    ...
    cartas.forEach(function(carta){
        ...
        const cartaNaoBateComFiltroDeCategoria = categoriaSelecionada.toLowerCase()
        ...
        const cartaBateComFiltroDePrecoMaximo = parseFloat(precoCarta) 
        > parseFloat(precoMaximoSelecionado);

        if(temFiltroDePreco && cartaBateComFiltroDePrecoMaximo ){
            mostrarCarta = false;
        }
        if(mostrarCarta){
